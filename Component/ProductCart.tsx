        ...
        <View style={styles.Container}>
            <View style={styles.CheckoutData}>
                ...
                <View style={styles.CheckoutText2}>
                    <Text style={styles.CheckoutSubHeading}>You save a total of $128.00 USD</Text>
                    <Text style={styles.CheckoutSubHeading}>VAT included</Text>
                </View>
            </View>

            <Pressable style={styles.CheckoutBtn} onPress={() => navigation.navigate("U_CheckoutScreen")}>
