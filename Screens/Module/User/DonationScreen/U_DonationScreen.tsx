    ...
    return (
        ...
        >
            ...
            <View style={styles.Block}>
                ...
                >
                    <Pressable style={styles.DonationBlock} onPress={() => navigation.navigate("U_DonationPaidScreen")}>
            ...
            <View style={styles.Block}>
                <View style={styles.BlockHeading}>
                    ...
                    <Pressable style={styles.ViewAll} onPress={() => navigation.navigate("U_OrganizationListScreen")}>
                ...
                >
                    ...
                    {new Array(5).fill(0).map((item, Organindex) => (
                        <Pressable key={Organindex} style={styles.OrgBlock} onPress={() => navigation.navigate("U_OrganizationDetailsScreen")}>
