...
import U_Footer from "../../../Component/U_Footer";
...
const Navs = [
    {
        name: "Profile",
        link: "U_MyProfileScreen",
        icon: Sidemenu_1
    },
    {
        name: "Donate",
        link: "U_DonationScreen",
        icon: Sidemenu_2
    },
    {
        name: "Prayer Wall",
        link: "U_PrayerBoardScreen",
        icon: Sidemenu_3
    },
    {
        name: "Events",
    ...
    {
        name: "About Us",
        link: "U_AboutUsScreen",
        icon: Sidemenu_6
    },
    {
        name: "Contact Us",
        link: "U_ContactUsScreen",
        icon: Sidemenu_7
    },
    {
        name: "Privacy Policy",
        link: "U_PrivacyPolicyScreen",
        icon: Sidemenu_8
    },
    {
        name: "Terms & Condition",
        link: "U_TermsConditionScreen",
        icon: Sidemenu_9
    },
]
...
function DrawerView({ setDrawer }: any) {
    ...
    function gotosettings() {
        Navigation.navigate("U_SettingScreen")
    }
    // function gotoLogin() {
...
export default function U_ScreenLayout(props: ScreenLayout) {
    const navigation = useNavigation<any>();
    ...
    return (
        <SafeAreaView style={styles.Container}>
            ...
            <Animated.View
                ...
                {!props.FooterHidden ? <U_Footer /> : null}
