...
import { BackgroundColor, HeadingColor, PrimaryColor, StatusBarBack, White } from "../../../../Constant/Color";
import Link from "../../../../Component/Link";
import { Back_6, Logo } from "../../../../Constant/Images";

export default function U_ChooseProfileScreen() {
        ...
        <SafeAreaView style={styles.Container}>
            ...
            <KeyboardAvoidingView>
                ...
                <View style={styles.InputContainer}>
                    <Pressable onPress={() => handleRouting("U_SignUpScreen")}>
                    ...
                    <Pressable style={styles.Gap} onPress={() => handleRouting("O_SignUpScreen")}>
                        <View style={styles.Button}>
