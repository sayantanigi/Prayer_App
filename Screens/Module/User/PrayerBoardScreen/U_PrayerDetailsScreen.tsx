...
export default function U_PrayerDetailsScreen() {
            ...
            <View style={styles.PrayerDetails}>
                ...
                <Pressable style={styles.ShareBtn}>
                    <Image style={styles.ShareBtnIcon}
                        source={Icon_13} resizeMode="center" />
                </Pressable>
                    ...
                    <View style={styles.PrayerData}>
                        <View style={styles.PrayerText}>
                            ...
                            <View style={styles.PrayerBtnContainer}>
                                <Pressable style={[styles.PrayerBtn, styles.DonationBtn]} onPress={() => navigation.navigate("U_DonationScreen")}>
