...
export default function U_OrderDetailScreen() {
        ...
        >
            <View style={styles.Container}>
                ...
                <View style={styles.OrderBody}>
                    ...
                    <View style={styles.OrderBlock}>
                        <View style={styles.OrderIcon}>
                            ...
                            <View style={[styles.OrderIconBar, styles.OrderIconBarInactive]}></View>
                        </View>
                        <View style={styles.OrderDataText}>
                    ...
                    <View style={styles.OrderBlock}>
                        <View style={styles.OrderIcon}>
                            <View style={[styles.OrderIconCircle, styles.OrderIconCircleInactive]}>
                                {/* <AntDesign name="check" size={18} color="white" /> */}
                            </View>
                            <View style={[styles.OrderIconBar, styles.OrderIconBarInactive]}></View>
                        </View>
                    ...
                    <View style={styles.OrderBlock}>
                        ...
                        <View style={styles.OrderDataText}>
                            ...
                            <Text style={styles.OrderSubText}>Estimated delivery date: August 25, 2023</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.OrderBottom}>
                    ...
                    <View style={styles.OrderSummaryBlock}>
                        ...
                        <Text style={styles.OrderSummaryTextSubHeading}>VISA **** 1234</Text>
                    </View>
                </View>

                {/* Btn */}
                <View style={styles.CancleBtnArea}>
                    <Pressable style={styles.CancleBtnBlock} onPress={() => setModalVisible(true)}>
            ...
            >
                <View style={styles.ModalContainer}>
                    <Pressable style={styles.ModalTop} onTouchEnd={onTouchEnd}></Pressable>
                    <View style={styles.CancleBlock}>
                        <Text style={styles.CancleHeading}>If you cancle now, you may not be able to purchase this product again.</Text>
                        <View style={styles.CancleBtnBlockData}>
                            <Pressable style={[styles.CancleBtn, styles.CancleBtn1]} onPress={() => setModalVisible(false)}>
                                <Text style={[styles.CancleButtonText, styles.CancleButtonText1]}>I would like to keep the order</Text>
                            </Pressable>
