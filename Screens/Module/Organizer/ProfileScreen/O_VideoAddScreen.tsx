...
export default function O_VideoAddScreen() {
    const navigation = useNavigation<any>();

    // SnackBar Alert
    const SuccessAlert = () => {
        SnackBar.show({
            text: "You've successfully added your video.",
            type: "LONG",
            actionText: "Ok",
            onActionPress: () => {
                SnackBar.hide();
    ...
    return (
        <O_ScreenLayout
            ...
            title="Add Video"
            BannerHeading="Add your Video"
            BannerImage={BlankImage}
        >
            <View style={styles.Container}>
                <View style={styles.InputBlock}>
                    <Text style={styles.Heading}>Video Image Cover</Text>
                    <View style={styles.Input}>
                        <ChooseFile></ChooseFile>
                    </View>
                </View>
                <View style={styles.InputBlock}>
                    <Text style={styles.Heading}>Video File</Text>
                    <View style={styles.Input}>
                        <ChooseFile></ChooseFile>
                    </View>
                </View>
                <View style={styles.InputBlock}>
                    ...
                    <View style={styles.Input}>
                        <TextInput style={styles.InputField} placeholder="Podcast Name">
                        </TextInput>
                        <Image
