...
export default function O_EditProfile() {
    ...
    >
      <View style={styles.Container}>
        ...
        <View style={styles.InputBlock}>
          ...
          <View style={styles.Input}>
            <TextInput
              defaultValue={getuserInfo && getuserInfo[0] ? getuserInfo[0].firstname : ""}
        ...
        <View style={styles.InputBlock}>
          ...
          <View style={styles.Input}>
            <TextInput
              defaultValue={getuserInfo && getuserInfo[0] ? getuserInfo[0].mobile : ""}
              style={styles.InputField}
        ...
        <Pressable onPress={handleSearch} style={styles.InputBlock}>
          ...
          <View style={styles.Input}>
            <TextInput
              editable={false}
              style={styles.InputField}
              defaultValue={getuserInfo && getuserInfo[0] ? getuserInfo[0].address : ""}
        ...
        <View style={styles.InputBlock}>
          ...
          <View style={styles.Input}>
            <TextInput
              ...
              defaultValue={getuserInfo && getuserInfo[0] ? getuserInfo[0].gender : ""}
              placeholder="Type Here"
            ></TextInput>
            <Image
              style={styles.InputImg}
