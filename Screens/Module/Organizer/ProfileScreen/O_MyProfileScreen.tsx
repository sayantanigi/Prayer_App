          ...
          <View style={[{ width }, styles.Block]}>
            <View style={styles.BlockContainer}>
              ...
              { getuserInfo?.map(function (item: Userinfo, index: number) {
                        return (
                          ...
                          <Text style={styles.SubHeading}>{item.firstname+" "+item.lastname}</Text>
                        </View>
              ...
              <Pressable onPress={() => gotoCareerTipsDetails()}
            ...
            <View style={styles.BlockContainer}>
              ...
              <View style={styles.DataContainer}>
                ...
                { getuserInfo?.map(function (item: Userinfo, index: number) {
                        return (
                          <Text style={styles.SubHeading}>{item.mobile}</Text>
            ...
            <View style={styles.BlockContainer}>
              ...
              <View style={styles.DataContainer}>
                ...
                { getuserInfo?.map(function (item: Userinfo, index: number) {
                        return (
                          <Text style={styles.SubHeading}>{item.gender}</Text>
              ...
              <View style={styles.VideoDataContainer}>
                {new Array(2).fill(0).map((item, Videoindex) => (
                  <Pressable
                    ...
                    onPress={() => navigation.navigate("O_VideoPlayerScreen")}
                  >
              ...
              <View style={styles.StoreDataContainer}>
                {new Array(1).fill(0).map((item, Storeindex) => (
                  <Pressable
                    ...
                    onPress={() => navigation.navigate("O_OrderDetailScreen")}
                  >
