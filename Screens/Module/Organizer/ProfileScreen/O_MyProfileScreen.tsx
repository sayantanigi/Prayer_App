...
import { BlankImage, BlankVideo, HomeIcon_3, HomeIcon_4, HomeIcon_5, Icon_11, Icon_41, Icon_42, Icon_43, Icon_44, Icon_45, Icon_46 } from "../../../../Constant/Images";
...
export default function O_MyProfileScreen() {
    ...
    const tabs = ["Profile", "Prayers", "Podcasts", "Videos", "Post", "Donation", "Store"]
                ...
                <Animated.View style={{
                    ...
                    <View style={[{ width }, styles.Block]}>
                        ...
                        <View style={styles.AddBtnContainer1}>
                            <Pressable style={styles.AddBtnBack} onPress={() => navigation.navigate("O_PrayerAddScreen")}>
                        ...
                        {new Array(2).fill(0).map((item, Eventindex) => (
                            <View key={Eventindex} style={styles.PrayerBlock}>
                                ...
                                <View style={styles.PrayerBtnContainer}>
                                    <Link style={styles.PrayerJoinBtn} to={"O_PrayerEditScreen"}>
                                        <Text style={styles.PrayerJoinBtnText}>Edit</Text>
                                        <Image style={styles.PrayerJoinBtnBack} source={HomeIcon_4} resizeMode="center" />
                                    </Link>
                                    <Link style={styles.PrayerViewBtn} to={"O_PrayerDetailsScreen"}>
                    ...
                    <View style={[{ width }, styles.Block]}>
                        ...
                        <View style={styles.AddBtnContainer2}>
                            <Pressable style={styles.AddBtnBack} onPress={() => navigation.navigate("O_PodcastAddScreen")}>
                    ...
                    <View style={[{ width }, styles.Block]}>
                        {/* Add Video Button */}
                        <View style={styles.AddBtnContainer2}>
                            <Pressable style={styles.AddBtnBack} onPress={() => navigation.navigate("O_VideoAddScreen")}>
                        ...
                        <View style={styles.BlockContainer}>
                            ...
                            <View style={styles.VideoDataContainer}>
                                {new Array(2).fill(0).map((item, Videoindex) => (
                    ...
                    <View style={[{ width }, styles.Block]}>
                        {/* Add Donation Button */}
                        <View style={styles.AddBtnContainer2}>
                            <Pressable style={styles.AddBtnBack} onPress={() => navigation.navigate("O_DonationAddScreen")}>
                        ...
                        <View style={styles.BlockContainer}>
                            ...
                            <View style={styles.StoreDataContainer}>
                                {new Array(1).fill(0).map((item, Storeindex) => (
                                    <Pressable key={Storeindex} style={styles.StoreContainer} onPress={() => navigation.navigate("O_OrderDetailScreen")}>
                        ...
                        <View style={styles.BlockContainer}>
                            ...
                            <View style={styles.StoreDataContainer}>
                                {new Array(4).fill(0).map((item, Storeindex) => (
                                    <Pressable key={Storeindex} style={styles.StoreContainer} onPress={() => navigation.navigate("O_ProductScreen")}>
                                        <View style={styles.StoreImgBlock}>
                                            <View style={styles.StoreBlock1}>
                                                <Image
                                                    style={styles.StoreImg}
