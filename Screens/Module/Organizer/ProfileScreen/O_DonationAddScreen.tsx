...
export default function O_DonationAddScreen() {
    const navigation = useNavigation<any>();

    // SnackBar Alert
    const SuccessAlert = () => {
        SnackBar.show({
            text: "You've successfully added your donation camp.",
            type: "LONG",
            actionText: "Ok",
            onActionPress: () => {
                SnackBar.hide();
    ...
    return (
        <O_ScreenLayout
            ...
            title="Add Donation"
            BannerHeading="Add your Donation Camp"
            BannerImage={BlankImage}
        >
            <View style={styles.Container}>
                <View style={styles.InputBlock}>
                    <Text style={styles.Heading}>Donation Cover Image</Text>
                    <View style={styles.Input}>
                        <ChooseFile></ChooseFile>
                    </View>
                </View>
                <View style={styles.InputBlock}>
                    <Text style={styles.Heading}>Donation Camp Name</Text>
                    <View style={styles.Input}>
                        <TextInput style={styles.InputField} placeholder="Donation Camp Name">
                        </TextInput>
                        <Image
                ...
                <View style={styles.InputBlock}>
                    <Text style={styles.Heading}>Donation Organizer Name</Text>
                    <View style={styles.Input}>
                        <TextInput style={styles.InputField} placeholder="Donation Organizer Name">
                        </TextInput>
                        <Image
                            style={styles.InputImg}
                            source={Back_2}
