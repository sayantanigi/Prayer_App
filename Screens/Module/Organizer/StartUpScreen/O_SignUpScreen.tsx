...
import { KeyboardAvoidingView, SafeAreaView, StyleSheet, View, Image, Text, TextInput, ScrollView, Pressable, ListRenderItemInfo, Modal, FlatList } from "react-native";
...
export default function O_SignUpScreen() {
  ...
  async function dataSubmit() {
    ...
    if (formData.organizer_name === "" || formData.organizer_name == null) {
      SnackBar.show({
        text: "Organizer name  is require",
        type: "LONG",
  ...
  else  if (formData.first_name === "" || formData.first_name == null) {
      SnackBar.show({
        ...
        <SafeAreaView style={styles.Container}>
          <KeyboardAvoidingView>
            ...
            >
              ...
              <Text style={styles.Heading}>Become an <Text style={{ color: PrimaryColor }}>Organizer</Text></Text>
              ...
              <View style={styles.Input}>
                  <TextInput
                    ...
                    onChangeText={(value) =>
                      handleFormDataChange("organizer_name", value)
                    }
