...
import { Back_2, Back_6, Icon_17, Icon_18, Logo } from "../../../../Constant/Images";
    ...
    <SafeAreaView style={styles.Container}>
      ...
      <KeyboardAvoidingView>
        ...
        <View style={styles.InputContainer}>
          ...
          <Link style={[styles.LinkStyle, styles.ForgotTextStyle]} to="O_ForgotPasswordScreen">Forgot Password?</Link>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
  );
