...
export default function O_StoreScreen() {
  ...
  function slideCompont(item: BannerList) {
    return (
      <ImageBackground
        resizeMode="cover"
        style={{
  ...
  useEffect(() => {
    console.log("Running", getCategory.length);
    setTabs([{ label: "All", image: Icon_59 }]);
    if (getCategory.length > 0) {
      getCategory.map((item) => {
        setTabs([
          ...tabs,
          { label: item.category_name, image: item.category_image },
        ]);
      });
    }
  }, [getCategory.length]);
 ...
 // productByCategory
  ...
  try {
    ...
    console.log(p_result.result[0].count)
 ...
 async function SuccessAlert(id: string) {
    ...
    let p_category = await fetch(`${routes.add_to_cart}`, {
      ...
      body: JSON.stringify({ user_id: user?.userId,product_id:id,quantity:"1"}),
      ...
      <View style={styles.TopContainer}>
        ...
        <View style={styles.CartBlock}>
          <Pressable
            ...
            onPress={() => navigation.navigate("O_ProductCartScreen")}
          > 
            <Image
        ...
        >
          ...
          <View style={[{ width }, styles.ProductBlock]}>
            ...
            <View style={[styles.ProductContainer]}>
                ...
                >
                  ...
                  <View style={styles.ProductData}>
                    <View style={styles.ProductText}>
                      <Text style={styles.ProductHeading}>Product kkkkName</Text>
              ...
              {getProductList && getProductList?.map(function (item: ProductList, index: number) {
                return (
                  <Pressable
                    style={styles.Product}
                    onPress={() => navigation.navigate("O_ProductScreen")}
                    ...
                    <View style={styles.ProductData}>
                      <View style={styles.ProductText}>
                        ...
                        <View style={styles.ProductPriceBlock}>
                          ...
                          <Text style={styles.ProductPriceCut}>{item.mrp}</Text>
