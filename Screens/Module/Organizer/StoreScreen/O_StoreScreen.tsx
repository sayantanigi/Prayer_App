        ...
        >
            ...
            <View style={styles.TopContainer}>
                ...
                <View style={styles.CartBlock}>
                    <Pressable style={styles.CartBack} onPress={() => navigation.navigate("O_ProductCartScreen")}>
                        <Image
                    ...
                    <View style={[{ width }, styles.ProductBlock]}>
                        ...
                        {new Array(3).fill(0).map((item, Productindex) => (
                            <View key={Productindex} style={styles.ProductContainer}>
                                ...
                                <Pressable style={styles.Product} onPress={() => navigation.navigate("O_ProductScreen")}>
