...
export default function O_PrayerBoardScreen() {
  ...
  useEffect(() => {
    ...
    function gotoCareerTipsDetails(id:string,name: string,prayer_image:string): void {
        navigation.navigate("O_PrayerJoinScreen",{"name":name, "images":prayer_image,"eventid":id})
  ...
  return (
    ...
    >
      ...
      <View style={styles.SearchBarContainer}>
        <TextInput style={styles.SearchBarInput} placeholder="Search Prayers" />
