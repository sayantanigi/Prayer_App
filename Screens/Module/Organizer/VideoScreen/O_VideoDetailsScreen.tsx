...
import { BlankImage, BlankVideo, Icon_26, Icon_28 } from "../../../../Constant/Images";

export default function O_VideoDetailsScreen() {
        ...
        >
            <View style={styles.ProfileData}>
                ...
                <Text style={styles.ProfileSubHeading}>
                    Nullam pharetra ante turpis, eget aliquet dui imperdiet
                    quis. Morbi bibendum consequat turpis, eget porta diam
                    ornare in. Proin sed ante sapien. Morbi est tellus, volutpat
                    et neque at, placerat fringilla nulla. Nunc congue lectus in
                    quam luctus euismod. Nunc vulputate dui vel nunc
                    elementum, a rutrum massa lacinia. Aenean ullamcorper
                    nibh ut turpis pellentesque, nec laoreet purus dictum.
                </Text>
            ...
            <View style={styles.DataBlock1}>
                ...
                >
                    {new Array(5).fill(0).map((item, Videoindex) => (
                        <Pressable key={Videoindex} style={styles.TOWBlock} onPress={() => navigation.navigate("O_VideoPlayerScreen")}>
